<section id="profile">
    ...
    <section id="actions">
        ...
        <ul>
            ...
            <li><button onclick="location.href = '<?= PROTOCOL_CLIENT_URL ?>/view_proposals.php'">Proposals to my pets</button></li>
            <li><button onclick="location.href = '<?= PROTOCOL_CLIENT_URL ?>/my_proposals.php'">My proposals</button></li>
            <li><button onclick="location.href = '<?= PROTOCOL_CLIENT_URL ?>/view_adopted_pets_by_user.php'">View adopted pets</button></li>
            <li><button onclick="location.href = '<?= PROTOCOL_CLIENT_URL ?>/view_previously_owned_pets.php'">View previously owned pets</button></li>
            <?php 
