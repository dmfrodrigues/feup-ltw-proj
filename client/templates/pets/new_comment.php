<form id="new-comment" class="answer" enctype="multipart/form-data" onsubmit="return newComment_checkTextOrImage(this)" action="<?= SERVER_URL ?>/action_add_comment.php" method="post">
