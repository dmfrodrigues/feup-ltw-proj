        ...
        <div id="proposal-msg"> 
            ...
            <div id="proposal-info">
                ...
                <div id="proposal-message-submit">
                    ...
                    <div id="proposal-messages-refresh"><button id="update" class="image" onclick="onClickedUpdateComments(this, () => console.log('test'))"><img src="resources/img/update.svg"/></button></div>
                </div>  
            </div>
        </div>
    <?php } ?>      
